...
class Vehicle(models.Model):
    ...
    class Meta:
        ...
        unique_together = (("make", "model", "year", "color", "vehicle_type", "serial_number"),) # not really needed due to serial_number being a primary key and providing uniqueness,
                                                                                                 # but I like composite keys (even though django dosn't support them)
